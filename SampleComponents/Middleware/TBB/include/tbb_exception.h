...
/** If an unhandled exception of the type derived from tbb_graphics_samples::tbb_exception is intercepted
    ...
    TBB provides two implementations of this interface: tbb_graphics_samples::captured_exception and
    template class tbb_graphics_samples::movable_exception. See their declarations for more info. **/
...
/** Exception of this type is thrown by TBB in the root thread (thread that started a parallel
    ...
    of the workers.
    \sa tbb_graphics_samples::tbb_exception **/
...
public:
    ...
    /*override*/ const char* what () const throw() { return "tbb_graphics_samples::movable_exception"; }
...
}; // class tbb_graphics_samples::internal::tbb_exception_ptr
