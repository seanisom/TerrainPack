...
namespace interface5 {
    namespace internal {
        ...
        /** TBB's evolution caused the "this" argument for several methods to become obsolete.
            ...
            using declarations. */
        class task_base: tbb_graphics_samples::internal::no_copy {
        __TBB_TASK_BASE_ACCESS:
            friend class tbb_graphics_samples::task;
            ...
            static tbb_graphics_samples::internal::allocate_additional_child_of_proxy allocate_additional_child_of( task& t ) {
                return tbb_graphics_samples::internal::allocate_additional_child_of_proxy(t);
            }
...
namespace internal {
    ...
    private:
        friend class tbb_graphics_samples::task;
        friend class tbb_graphics_samples::interface5::internal::task_base;
        friend class tbb_graphics_samples::task_list;
        ...
        tbb_graphics_samples::task* parent;
        ...
        tbb_graphics_samples::task* next;

        //! The task corresponding to this task_prefix.
        tbb_graphics_samples::task& task() {return *reinterpret_cast<tbb_graphics_samples::task*>(this+1);}
    };
...
public:
    ...
    enum state_type {
        ...
        recycle 
#if INTEL_PRIVATE && __TBB_RECYCLE_TO_ENQUEUE
...
#if INTEL_PRIVATE && __TBB_RECYCLE_TO_ENQUEUE
// recycle_to_enqueue can be provided but we are not sure it should.
...
inline void *operator new( size_t bytes, const tbb_graphics_samples::internal::allocate_root_proxy& ) {
    return &tbb_graphics_samples::internal::allocate_root_proxy::allocate(bytes);
}

inline void operator delete( void* task, const tbb_graphics_samples::internal::allocate_root_proxy& ) {
    tbb_graphics_samples::internal::allocate_root_proxy::free( *static_cast<tbb_graphics_samples::task*>(task) );
}

#if __TBB_TASK_GROUP_CONTEXT
inline void *operator new( size_t bytes, const tbb_graphics_samples::internal::allocate_root_with_context_proxy& p ) {
    return &p.allocate(bytes);
}

inline void operator delete( void* task, const tbb_graphics_samples::internal::allocate_root_with_context_proxy& p ) {
    p.free( *static_cast<tbb_graphics_samples::task*>(task) );
}
#endif /* __TBB_TASK_GROUP_CONTEXT */

inline void *operator new( size_t bytes, const tbb_graphics_samples::internal::allocate_continuation_proxy& p ) {
    return &p.allocate(bytes);
}

inline void operator delete( void* task, const tbb_graphics_samples::internal::allocate_continuation_proxy& p ) {
    p.free( *static_cast<tbb_graphics_samples::task*>(task) );
}

inline void *operator new( size_t bytes, const tbb_graphics_samples::internal::allocate_child_proxy& p ) {
    return &p.allocate(bytes);
}

inline void operator delete( void* task, const tbb_graphics_samples::internal::allocate_child_proxy& p ) {
    p.free( *static_cast<tbb_graphics_samples::task*>(task) );
}

inline void *operator new( size_t bytes, const tbb_graphics_samples::internal::allocate_additional_child_of_proxy& p ) {
    return &p.allocate(bytes);
}

inline void operator delete( void* task, const tbb_graphics_samples::internal::allocate_additional_child_of_proxy& p ) {
    p.free( *static_cast<tbb_graphics_samples::task*>(task) );
}
