...
/** @ingroup containers */
    template <typename T>
        class combinable {
    private:
        typedef typename tbb_graphics_samples::cache_aligned_allocator<T> my_alloc;

        typedef typename tbb_graphics_samples::enumerable_thread_specific<T, my_alloc, ets_no_key> my_ets_type;
        my_ets_type my_ets; 
