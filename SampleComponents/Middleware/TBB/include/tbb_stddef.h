...
#if _MSC_VER
// define the parts of stdint.h that are needed, but put them inside tbb_graphics_samples::internal
...
//! The namespace tbb_graphics_samples contains all components of the library.
namespace tbb_graphics_samples {
...
#define __TBB_ASSERT(predicate,message) ((predicate)?((void)0):tbb_graphics_samples::assertion_failure(__FILE__,__LINE__,#predicate,message))
...
void __TBB_EXPORTED_FUNC handle_perror( int error_code, const char* aux_info );
    ...
    #define __TBB_TRY
    #define __TBB_CATCH(e) if ( tbb_graphics_samples::internal::__TBB_false() )
