...
namespace internal {
    ...
    public:
        ...
        void swap( tbb_thread_v3& t ) {tbb_graphics_samples::swap( *this, t );}
    ...
    private:
        ...
        friend void tbb_graphics_samples::swap( tbb_thread_v3& t1, tbb_thread_v3& t2 ); 
    };
...
inline void swap( internal::tbb_thread_v3& t1, internal::tbb_thread_v3& t2 ) {
    tbb_graphics_samples::tbb_thread::native_handle_type h = t1.my_handle;
