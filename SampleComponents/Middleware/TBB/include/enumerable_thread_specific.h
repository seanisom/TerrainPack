...
namespace interface6 {
    ...
    namespace internal { 
        ...
        class ets_base: tbb_graphics_samples::internal::no_copy {
        protected:
#if _WIN32||_WIN64
        ...
        public:
            ...
            struct slot {
                ...
                bool claim( key_type k ) {
                    __TBB_ASSERT(sizeof(tbb_graphics_samples::atomic<key_type>)==sizeof(key_type), NULL);
                    return tbb_graphics_samples::internal::punned_cast<tbb_graphics_samples::atomic<key_type>*>(&key)->compare_and_swap(k,0)==0;
                }
            };
#if __TBB_GCC_3_3_PROTECTED_BROKEN
        protected:
            ...
            static key_type key_of_current_thread() {
               tbb_graphics_samples::tbb_thread::id id = tbb_graphics_samples::this_tbb_thread::get_id();
               key_type k;
    ...
    template<typename SegmentedContainer, typename Value >
        ...
        template<typename T>
        struct destruct_only: tbb_graphics_samples::internal::no_copy {
            tbb_graphics_samples::aligned_space<T,1> value;
            ~destruct_only() {value.begin()[0].~T();}
        };

        template<typename T>
        struct construct_by_default: tbb_graphics_samples::internal::no_assign {
            void construct(void*where) {new(where) T();} // C++ note: the () in T() ensure zero initialization.
            construct_by_default( int ) {}
        };

        template<typename T>
        struct construct_by_exemplar: tbb_graphics_samples::internal::no_assign {
            const T exemplar;
        ...
        struct construct_by_finit: tbb_graphics_samples::internal::no_assign {
            Finit f;
        ...
        class callback_leaf: public callback_base<T>, Constructor {
            ...
            typedef typename tbb_graphics_samples::tbb_allocator<callback_leaf> my_allocator_type;
        ...
        */
        ...
        struct ets_element {
            char value[ModularSize==0 ? sizeof(U) : sizeof(U)+(tbb_graphics_samples::internal::NFS_MaxLineSize-ModularSize)];
            void unconstruct() {
                tbb_graphics_samples::internal::punned_cast<U*>(&value)->~U();
            }
        };
    ...
    class enumerable_thread_specific: internal::ets_base<ETS_key_type> { 
        ...
        typedef internal::ets_element<T,sizeof(T)%tbb_graphics_samples::internal::NFS_MaxLineSize> padded_element;
        ...
        typedef tbb_graphics_samples::concurrent_vector< padded_element, padded_allocator_type > internal_collection_type;
